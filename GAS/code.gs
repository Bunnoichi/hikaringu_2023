spreadsheed_id_name = '1eMzeXi5sRGg0pzl2N_sF921V57P9VeVsCuGr4-JHySo'
...
function doGet() {
  ...
  // 入荷数を取得
  htmlOutput.array_in = targetSheet.getRange("C7:C12");

  // 伝言を取得
  var targetSheet = spreadSheet.getSheetByName('message');
...
function getEarnings() {
  var spreadSheet = SpreadsheetApp.openById(spreadsheed_id_name);
  var targetSheet = spreadSheet.getSheetByName('informations');
  range1 = targetSheet.getRange("B7:B12");
