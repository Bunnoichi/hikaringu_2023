...
google.script.run
  ...
  function earning_display_update() {
      ...
      google.script.run.withSuccessHandler(function(updated_array){
        ...
        var display_G = document.getElementById('earning_display_child_G_span');
        ...
        display_G.textContent = updated_array[3][0];
        display_Ra.textContent = updated_array[4][0];
        display_W.textContent = updated_array[5][0];
